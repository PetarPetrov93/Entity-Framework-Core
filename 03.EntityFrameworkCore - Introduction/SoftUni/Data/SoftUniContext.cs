    ...
    public partial class SoftUniContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>(entity =>
            {
                ...
                // THIS WAS THE AUTO GENERATED CODE FOR REPRESENTING THE MAPPING TABLE FOR EMPLOYEESPROJECTS AND CONFIGURING THE COMPOSITE PK
            ...
            // THIS IS OUR OWN CONFIGURATION FOR THE MAPPING TABLE EMPLOPYEESPROJECTS AND OUR OWN CONFIGURATION FOR THE PK AND FKs
            modelBuilder.Entity<EmployeeProject>(entity =>
            {
                //This is how to set a composite PK on a mapping table
                entity.HasKey(pk => new { pk.EmployeeId, pk.ProjectId });

                //This is how to set the FKs
